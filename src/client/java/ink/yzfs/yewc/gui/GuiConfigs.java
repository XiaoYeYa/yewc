...
public class GuiConfigs extends GuiConfigsBase {
    ...
    public GuiConfigs() {
        super(10, 50, Reference.MOD_ID, null, "yewc.gui.title.configs");
    }
    ...
    public enum ConfigGuiTab {
        GENERIC("yewc.gui.button.config_gui.generic"),
        HOTKEYS("yewc.gui.button.config_gui.hotkeys");
